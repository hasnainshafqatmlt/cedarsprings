...
<div id="fh5co-featured" style="background-image: url(/images/wood_1.png); background-position: 0px 0px; padding-top: 0;">
    <div>
        ...
        <div class="registration-steps tw-hidden md:tw-flex">
        ...
        <!-- Navigation links -->
        <div class="play-pass-navigation tw-flex md:tw-justify-center tw-justify-between tw-flex-wrap tw-mb-5 tw-gap-3">
        ...
        <?php if (
            ...
            <div class="play-pass-section" id="current-selections">
                ...
                <div class="checkout-section">
                    <button onclick="handleProcessPlayPassCheckout()" class="btn tw-btn-secondary !tw-py-[18px] !tw-px-[20px] !tw-text-[22px]"
...
wp_enqueue_script('playpass-js', plugin_dir_url(__FILE__) . 'js/playpass.js', array('jquery'), '3.0.0', true);
wp_enqueue_style('bootstrap-modal-css', plugin_dir_url(__FILE__) . 'css/bootstrap-modal.css', array(), '1.0.0');
wp_enqueue_style('playpass-css', plugin_dir_url(__FILE__) . 'css/playpass.css', array(), '1.0.0');
?>
