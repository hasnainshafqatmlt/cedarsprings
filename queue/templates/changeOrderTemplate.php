                    ...
                    <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;margin:10px auto;">
                        ...
                        <tr>
                            <td class="mobile-padding" style="padding:20px 30px 11px 30px;background-color:#ffffff;text-align:center;">
                                <h1 style="margin-top:0;margin-bottom:16px;font-size:26px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;">Camper Queue Change Order</h1>
                                {{ development }}
                            </td>
                        </tr>
                        <tr>
                            <td class="mobile-padding" style="padding:0 30px 11px 30px;background-color:#ffffff;">
                                <p style="margin-top:0;margin-bottom:12px;">A preferred camp has become available for a customer and their reservation needs to be modified.</p>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td style="padding:15px;vertical-align:top;">
                                            <p style="margin:0;">
                                                ...
                                                <strong>New Camp:</strong> {{ new_camp }}<br>
                                                <strong>New Pod:</strong> {{ pod }}
                                            </p>
                                        </td>
                                        <td style="padding:15px;vertical-align:top;">
                                            <p style="margin:0;">
                                                <strong>Week:</strong> {{ session }}<br>
                                                <strong>Previous Camp:</strong> {{ old_camp }}
                                            </p>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td class="mobile-padding" style="padding:0 30px 20px 30px;background-color:#ffffff;text-align:center;">
                                <p style="margin:0;">This reservation needs to be updated in Ultracamp, exchanging the old camp for the new camp and pod. There is no need to confirm with the customer when this has been completed as Ticketmaster will automatically generate an email.</p>
                            </td>
                        </tr>
                        <tr>
