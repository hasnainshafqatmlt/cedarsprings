                    ...
                    <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;margin:10px auto;">
                        ...
                        <tr>
                            <td class="mobile-padding" style="padding:20px 30px 11px 30px;background-color:#ffffff;text-align:center;">
                                <h1 style="margin-top:0;margin-bottom:16px;font-size:26px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;">Add Camp to Reservation</h1>
                                {{ development }}
                            </td>
                        </tr>
                        <tr>
                            <td class="mobile-padding" style="padding:0 30px 11px 30px;background-color:#ffffff;">
                                <p style="margin-top:0;margin-bottom:12px;">A camper's reservation needs to be updated to include a day camp option with their existing Campfire Nights reservation.</p>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td style="padding:15px;vertical-align:top;">
                                            <p style="margin:0;">
                                                ...
                                                <strong>Bus/Zone:</strong> {{ bus }}<br>
                                                <strong>Ext. Care:</strong> {{ extCare }}
                                            </p>
                                        </td>
                                        <td style="padding:15px;vertical-align:top;">
                                            <p style="margin:0;">
                                                <strong>Week:</strong> {{ session }}<br>
                                                <br>
                                                <strong>Camp:</strong> {{ new_camp }}<br>
                                                <strong>Pod:</strong> {{ pod }}<br>
                                                <strong>Hot Lunch:</strong> {{ hotLunch }}
                                            </p>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td class="mobile-padding" style="padding:0 30px 20px 30px;background-color:#ffffff;text-align:center;">
                                <p style="margin:0;">This reservation needs to be updated in Ultracamp, adding the camp choice and pod to the customer's stand-alone Campfire Night reservation. There is no need to confirm with the customer when this has been completed as Ticketmaster will automatically generate an email.</p>
                            </td>
                        </tr>
                        <tr>
